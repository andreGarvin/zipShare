...
def set_time( end_time ):
    ...
    if end_time[1] == ' ':
        ...
        if int( time_now[3:len(time_now)][0] ) == 0:
            ...
            #     end_time = int( time_now[1:] ) + ':' + str( end_time )
                
            #     return end_time
            
            # else:
                
                # end_time = '0' + str( int( time_now[1:2] ) - 5) +':'+ str( int( end_time[0] ) + int( time_now[3:len(time_now)] ) )
            return end_time
    ...
    # if end_time varible is double digit 
        ...
        if int( end_time ) < 60:
            ...
            # end_time = '0' + str( int( time_now[0:2] ) - 5 ) + ':' + str(  int( end_time) )
