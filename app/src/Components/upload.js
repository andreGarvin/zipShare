...
export default class Upload extends Component {
    render() {
        ...
        return (
            <div id='uploadContainer' className='bin col-xs-6 col-sm-4 col-md-4 col-xs-offset-3 col-md-offset-1'>
                <h2>Upload file here</h2>
                <div className="progress">
                    <div className="progress-bar" id='progressBar' role="progressbar" value="0" max="100" style={{width: '0%'}}></div>
                </div>
